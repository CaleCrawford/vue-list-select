...
var __vue_render__ = function __vue_render__() {
  ...
  }, [_vm._ssrNode("<div class=\"options\">" + _vm._ssrList(_vm.list, function (item, index) {
    return "<div>" + (_vm.showItem(item) ? "<div>" + _vm._ssrEscape(_vm._s(item)) + "</div>" : "<!---->") + "</div>";
  }) + "</div> <br> <br> <div class=\"selected\">" + _vm._ssrList(_vm.value, function (item, index) {
    return "<div><div>" + _vm._ssrEscape(_vm._s(item)) + "</div></div>";
  }) + "</div>")]);
};
...
var __vue_module_identifier__ = "data-v-809bc184";
/* functional template */
